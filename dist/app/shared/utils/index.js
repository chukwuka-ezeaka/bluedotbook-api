...
export const pageCount = ({ count, page, pageSize, }) => {
    ...
    return {
        ...
        nextPage,
        pageTotal,
        pageSize: pageSize > count ? parseInt(String(count)) : parseInt(String(pageSize)),
    };
};
...
export const search = async (params) => {
    console.log("🚀 ~ file: misc.service.ts:71 ~ MiscCLass ~ search ~ params:", params);
    let query = {};
    let date;
    let endDate;
