...
export declare const getSingleCategory: (req: Request, res: Response, next: NextFunction) => Promise<any>;
export declare const editCategory: (req: Request, res: Response, next: NextFunction) => Promise<any>;
export declare const deleteCategory: (req: Request, res: Response, next: NextFunction) => Promise<any>;
